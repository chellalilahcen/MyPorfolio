...
const translations = {
    en: {
        ...
        exp_1_title: "IT Engineer",
        exp_1_subtitle: "SONELGAZ (Algerian National Electricity & Gas Company)",
        exp_1_desc: "Web Development (3 Years) & IT Support/Administration (6 Years)",
        exp_2_title: "IT Engineer",
        exp_2_subtitle: "University of Laghouat – Services Office",
        exp_2_desc: "Responsible for Computers & Networks",
        exp_3_title: "ICDL Teacher",
        exp_3_subtitle: "University of Laghouat / IAE Institut + Chamber of Commerce",
        exp_3_desc: "Taught Computer Basics, Word, Excel, and Presentation skills.",
        exp_4_title: "Internship: Warehouse Management",
        exp_4_subtitle: "SONATRACH",
        exp_4_desc: "Development of a Desktop App.",
    ...
    de: {
        ...
        exp_1_title: "IT-Ingenieur",
        exp_1_subtitle: "SONELGAZ (Algerische Nationale Elektrizitäts- & Gasgesellschaft)",
        exp_1_desc: "Web-Entwicklung (3 Jahre) & IT-Support/Administration (6 Jahre)",
        exp_2_title: "IT-Ingenieur",
        exp_2_subtitle: "Universität von Laghouat – Servicebüro",
        exp_2_desc: "Verantwortlich für Computer & Netzwerke",
        exp_3_title: "ICDL-Lehrer",
        exp_3_subtitle: "Universität Laghouat / IAE Institut + Handelskammer",
        exp_3_desc: "Unterrichtete Computer-Grundlagen, Word, Excel und Präsentationsfähigkeiten.",
        exp_4_title: "Praktikum: Lagerverwaltung",
        exp_4_subtitle: "SONATRACH",
        exp_4_desc: "Entwicklung einer Desktop-App.",
    ...
    fr: {
        ...
        exp_1_title: "Ingénieur IT",
        exp_1_subtitle: "SONELGAZ (Société Nationale Algérienne de l'Électricité et du Gaz)",
        exp_1_desc: "Développement Web (3 ans) & Support/Administration IT (6 ans)",
        exp_2_title: "Ingénieur IT",
        exp_2_subtitle: "Université de Laghouat – Bureau des Services",
        exp_2_desc: "Responsable des Ordinateurs et Réseaux",
        exp_3_title: "Enseignant ICDL",
        exp_3_subtitle: "Université de Laghouat / Institut IAE + Chambre de Commerce",
        exp_3_desc: "Enseignement des bases de l'informatique, Word, Excel et des compétences de présentation.",
        exp_4_title: "Stage : Gestion d'entrepôt",
        exp_4_subtitle: "SONATRACH",
        exp_4_desc: "Développement d'une application de bureau.",
